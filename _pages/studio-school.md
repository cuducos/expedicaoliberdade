...
Na nossa Expedição conhecemos uma [Studio School](https://www.studioschoolstrust.org/), foi a [TESS (Tendring Enterprise Studio School)](https://tendringenterprisestudioschool.org), na pequena cidade de [Clacton-on-Sea](https://www.google.com/maps/place/Clacton-on-Sea,+Essex,+UK). A região, além de rural, é uma das mais pobres da Inglaterra. Muitas casa ali não tem coisas que são consideradas básicas para o padrão de vida inglês, como calefação, banda larga, e sistema de gás encanado. Muitas famílias vivem há gerações apenas de benefícios do governo. E é nesse contexto sócio-econômico pouco favorável que a escola tenta criar oportunidades:
